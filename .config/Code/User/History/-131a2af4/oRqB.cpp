...
int main() {
    ...
    return 0;
}[8:06 PM, 3/31/2024] Muhammad Ali: yar bas dekh lena 12 se pehle pehle
[8:06 PM, 3/31/2024] Rafay Ahmad: Ok ok
[8:06 PM, 3/31/2024] Muhammad Ali: thanx
[8:55 PM, 3/31/2024] Muhammad Ali: #include<iostream>
#include<cstring>
using namespace std;
